...
$string['error_no_permission'] = 'You do not have permission to edit this image.';
...
$string['privacy:metadata:userid'] = 'The user who started an image job.';
$string['privacy:metadata:versiontable'] = 'Stores metadata about archived image versions for embedded content.';
$string['privacy:metadata:locktable'] = 'Stores in-flight image job locks per file location.';
...
$string['privacy:metadata:jobid'] = 'The remote Dixeo job identifier.';
$string['privacy:metadata:status'] = 'The job status.';
$string['privacy:metadata:errormessage'] = 'Any error message from a failed job.';
$string['privacy:metadata:timemodified'] = 'When the job lock was last updated.';
$string['privacy:pathversions'] = 'Image version history';
$string['privacy:pathlocks'] = 'Image job locks';
$string['close'] = 'Close';
...
$string['task_poll_content_image'] = 'Poll Dixeo content image job';
