...
/**
 * Tests for delete_version external.
 *
...
use context_module;
use filter_dixeo_imageeditor\external\delete_version;
...
/**
 * Tests for the delete_version external function.
 *
...
final class delete_version_test extends \advanced_testcase {
    ...
    public function test_delete_version_removes_history_entry(): void {
        global $USER;
    ...
    public function test_delete_version_rejects_foreign_versionid(): void {
        global $USER;
    ...
    public function test_delete_version_uses_delete_blocked_when_locked(): void {
        global $USER;
        ...
        try {
            ...
            $this->assertSame('error_delete_blocked', $e->errorcode);
        }
    }
